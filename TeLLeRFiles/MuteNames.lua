...
if DevAbs:get(TeLLeR.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(TeLLeR.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(TeLLeR.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(TeLLeR.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(TeLLeR.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(TeLLeR.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
TeLLeRName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if TeLLeRName then 
TeLLeRNames = DevAbs:smembers(TeLLeR.."Abs:Mute:Names"..msg.chat_id_) or ""
if TeLLeRNames and TeLLeRNames[1] then 
for i=1,#TeLLeRNames do 
if TeLLeRName:match("(.*)("..TeLLeRNames[i]..")(.*)") then 
...
DevAbs:set(TeLLeR.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(TeLLeR.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
